package is.pig.minecraft.admin.bootstrap;

import net.fabricmc.api.ModInitializer;
import net.fabricmc.loader.api.FabricLoader;
import is.pig.minecraft.admin.api.IModAdapter;
import is.pig.minecraft.admin.common.PiggyCore;
...
public class PiggyModBootstrap implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        if (selectedAdapter != null) {
            ...
            System.err.println("piggy-admin: Failed to find suitable ModAdapter for version " + version);
        }
    }
